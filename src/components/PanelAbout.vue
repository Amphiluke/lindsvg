<template>
  ...
  >
    ...
    <div class="panel-body thin-scroll">
      ...
      <p>
        There are a few L-system collections built in the app for demonstration purposes. These L-systems were gathered from various sources including the web, books, and articles. I appreciate the authors of these L-systems (you may find their names <a href="https://github.com/Amphiluke/lindsvg/blob/gh-pages/src/store/bank.js" target="_blank" rel="noopener">in the app sources</a>).
      </p>
      <h3>Links</h3>
      <ul>
        <li>
